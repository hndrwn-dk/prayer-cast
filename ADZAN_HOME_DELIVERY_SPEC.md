...
- On fire: start a foreground service (`connectedDevice` type — not
  `mediaPlayback`; the service holds locks and starts Dart for Cast /
  LAN coordination, it does not play audio) holding:
  - `PARTIAL_WAKE_LOCK`
